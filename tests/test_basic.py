from owocryptor import copy_sampledata_to_dest, delete_sampledata_from_dest, SAMPLE_DATA_DEST_PATH, \
    encrypt_folder_recursively, ENC_FILE_EXT
...
class TestBasic(unittest.TestCase):
    ...
    def test_can_create_files(self):
        ...
        assert (os.path.exists(SAMPLE_DATA_DEST_PATH + "/test.txt" + ENC_FILE_EXT))
